...
var focusableContent = new Array<HTMLElement>();

export function getWidgetTheme(themeID: string, _theme=null as string|null) {
...
export function setStyleSheet(href: string, id=null as string|null): void {
  ...
  if (id) {
    var ss_node = document.getElementById(id) as HTMLLinkElement;
    if (ss_node) {
      ss_node.href = href;
      return;
    } else {
...
export function createReactDiv(parent_node: HTMLDivElement, div_id: string, classNameList=[""] as Array<string>) {
